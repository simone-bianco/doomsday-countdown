...
final class BackofficeCountdownService
{
    ...
    private function initiative(Initiative $initiative): array
    {
        return [
            ...
            'url' => $initiative->url,
            'content_type' => $initiative->content_type,
            'preview_image_url' => $initiative->preview_image_url,
            'embed_url' => $initiative->embed_url,
            'external_provider' => $initiative->external_provider,
