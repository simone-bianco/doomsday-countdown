  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), {
        title: `Edit projection · ${__props.projection.title.en ?? __props.countdown.slug}`
      }, null, _parent));
      _push(ssrRenderComponent(_sfc_main$1, {
        "active-section": activeSection.value,
        "onUpdate:activeSection": ($event) => activeSection.value = $event,
        title: "Edit projection",
        subtitle: `Update ${__props.projection.title.en ?? "projection"} for ${__props.countdown.title.en ?? __props.countdown.slug}.`,
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_sfc_main$3, {
                    ...
                    projection: __props.projection,
                    "submit-url": submitUrl.value,
                    method: "put",
                    "submit-label": "Save projection",
                    "show-top-actions": "",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Backoffice/Countdowns/Projections/Edit.vue");
