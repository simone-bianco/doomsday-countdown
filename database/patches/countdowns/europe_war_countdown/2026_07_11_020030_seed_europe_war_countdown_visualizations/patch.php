...
return new class extends Patch
{
    ...
    public function up(): void
    {
        ...
        $neutralProjection->visualizations()->whereIn('key', [
            'projection_curve',
            'readiness_scenario_curve',
        ])->delete();
    ...
    public function down(): void
    {
        ...
        $countdown->visualizations()->whereIn('key', array_map(
    ...
    private function countdown(): Countdown
    {
        ...
        if (! $countdown instanceof Countdown) {
            throw new RuntimeException('Europe war countdown must exist before seeding visualizations.');
        }
    ...
    private function neutralProjection(Countdown $countdown): Projection
    {
        ...
        if (! $projection instanceof Projection) {
            throw new RuntimeException('Neutral Europe projection must exist before seeding visualizations.');
        }
