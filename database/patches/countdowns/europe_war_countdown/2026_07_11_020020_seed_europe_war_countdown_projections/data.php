    ...
    public function projections(): array
    {
        ...
        return [
            ...
            [
                ...
                'summary' => $this->shared->t(en: 'The main timer marks the point where NATO’s public 2029/end-decade warning and the EU’s end-2030 delivery plan converge.', it: 'Il timer principale segna il punto in cui l’avvertimento NATO sul 2029/fine decennio converge con il piano UE di consegne entro fine 2030.', fr: 'Le minuteur principal marque le point où l’alerte de l’OTAN pour 2029/la fin de décennie rejoint le plan de livraisons de l’UE à fin 2030.', de: 'Der Haupttimer markiert den Punkt, an dem die NATO-Warnung für 2029/das Jahrzehntende mit dem EU-Lieferplan bis Ende 2030 zusammenläuft.', es: 'El temporizador principal marca el punto en que la alerta de la OTAN para 2029/final de década converge con el plan de entregas de la UE para finales de 2030.', nl: 'De hoofdtimer markeert het punt waar de NAVO-waarschuwing voor 2029/einde decennium samenkomt met het EU-leveringsplan voor eind 2030.', sv: 'Huvudtimern markerar punkten där Natos varning för 2029/årtiondets slut möter EU:s leveransplan till slutet av 2030.', pl: 'Główny licznik wskazuje punkt, w którym ostrzeżenie NATO dotyczące 2029/końca dekady zbiega się z planem dostaw UE do końca 2030 roku.'),
                'confidence_score' => 72,
