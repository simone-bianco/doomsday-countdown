...
return new class extends Patch
{
    ...
    private function countdown(): Countdown
    {
        ...
        if (! $countdown instanceof Countdown) {
            throw new RuntimeException('Antibiotic apocalypse countdown must exist before seeding visualizations.');
        }
    ...
    private function neutralProjection(Countdown $countdown): Projection
    {
        ...
        if (! $projection instanceof Projection) {
            throw new RuntimeException('Neutral projection must exist before seeding AMR projection visualizations.');
        }
