...
return new class extends Patch
{
    ...
    private const IMAGE_PATH = 'images/doomsday/extreme_heat_breakpoint_separate.png';
    ...
    public function up(): void
    {
        ...
        $countdown->initiatives()->whereIn('url', $this->ownedUrls())->delete();
    ...
    private function countdown(): Countdown
    {
        ...
        if (! $countdown instanceof Countdown) {
            throw new RuntimeException('Unlivable Heat countdown must exist before seeding initiatives.');
        }
