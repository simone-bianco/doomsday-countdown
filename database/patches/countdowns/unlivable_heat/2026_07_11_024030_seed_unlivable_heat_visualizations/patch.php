...
return new class extends Patch
{
    ...
    private function countdown(): Countdown
    {
        ...
        if (! $countdown instanceof Countdown) {
            throw new RuntimeException('Unlivable Heat countdown must exist before seeding visualizations.');
        }
    ...
    private function neutralProjection(Countdown $countdown): Projection
    {
        ...
        if (! $projection instanceof Projection) {
            throw new RuntimeException('Neutral Unlivable Heat projection must exist before seeding its chart.');
        }
