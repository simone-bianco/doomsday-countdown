...
$backupDisks = array_values(array_filter(array_map(
    ...
    explode(',', (string) env('BACKUP_DISKS', 'backup')),
)));
...
$notificationEmail = trim((string) env('BACKUP_NOTIFICATION_EMAIL', ''));
$notificationChannels = $notificationEmail !== '' ? ['mail'] : [];
$mailRecipient = $notificationEmail !== '' ? $notificationEmail : 'backup@localhost.invalid';
...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        'name' => env('BACKUP_NAME', 'doomsday-clock'),
         ...
         */
        'encryption' => env('BACKUP_ARCHIVE_PASSWORD') ? 'aes256' : 'none',
         ...
         */
        'tries' => (int) env('BACKUP_TRIES', 2),

        /*
         * The number of seconds to wait before attempting a new backup if the previous try failed
         * Set to `0` for none
         */
        'retry_delay' => (int) env('BACKUP_RETRY_DELAY', 60),
    ],
     ...
     */
    'notifications' => [
        'email_configured' => $notificationEmail !== '',
    ...
    'schedule' => [
        ...
        'timezone' => env('BACKUP_TIMEZONE', 'Europe/Rome'),
        'cleanup_time' => env('BACKUP_CLEANUP_TIME', '03:30'),
        'monitor_time' => env('BACKUP_MONITOR_TIME', '04:00'),
    ],
